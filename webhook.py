...
def process_request(req):
    try:
        ...
        # Giving Jobs Details
            ...
            speech = "We have various types of jobs avaible and we are always ready to hire smart candidates. You can browse through various jobs and apply for the job you liked most."
            return {
                "speech": speech,
                "displayText": speech,
                "source": "webhook",
